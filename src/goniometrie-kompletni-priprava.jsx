      ...
      <Collapsible title="Př. 1: Sinusoida z cvičného testu" badge="Medium" defaultOpen={true}>
        ...
        <FunctionGraph
          ...
          keyPoints={[
            ...
            { x: Math.PI / 4, y: 0, label: "(π/4, 0)", color: "#22c55e", labelOffset: [-58, -8] },
            { x: Math.PI / 2, y: -2, label: "(π/2, −2)", color: "#fbbf24", labelOffset: [8, 14] },
            { x: 3 * Math.PI / 4, y: 0, label: "(3π/4, 0)", color: "#22c55e", labelOffset: [8, 18] },
          ]}
